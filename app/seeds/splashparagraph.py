...
def seed_splashparagraphs():
    paragraphs=[SplashParagraph(title='Splash Header',header='Feel better with Aurora',paragraph='Aurora is an AI emotional wellness companion offering a unique blend of personalized support through conversation, mood tracking, and mindset tools, all in a safe space for self-exploration and growth.'),
                SplashParagraph(title='bio',header='Meet the Founder',paragraph="<p>Hi there! I'm Christina, a product designer with a passion for personal growth and mental well-being. <br><br> I believe everyone should have access to knowledge and tools that lead to joy and fulfillment in life. And that's the heart behind Aurora. I hope you love her as much as I do 💛.</p>"),
